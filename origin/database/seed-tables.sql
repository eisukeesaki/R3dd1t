...
INSERT INTO comments (id, _user, _post, _parent, body) -- constant record
    VALUES
        (uuid_nil (), uuid_nil (), uuid_nil (), uuid_nil (), uuid_nil ());
INSERT INTO comments (id, _user, _post, body) -- direct comments (comments which does not reference other comments)
    VALUES
        ...
        (gen_random_uuid (), '0f99c8f3-2358-4d10-b8f8-e6812f4f63bf', '289b133f-bec3-4196-8752-59ce5aa717d6', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.'),
        (gen_random_uuid (), 'a541fd15-37db-4b54-9501-78cde1ff9ba8', 'cb256027-cd57-4317-8d71-5b8fdf031545', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.');
